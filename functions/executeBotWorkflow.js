 ...
 * Execute loop node
 */
async function executeLoopNode(node, context, _base44) {
    try {
 ...
 */
async function executeParallelNode(node, context, _base44) {
    try {
 ...
 */
async function executeDatabaseQuery(details, variables, _base44) {
    // Parse query details
