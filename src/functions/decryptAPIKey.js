...
Deno.serve(async (req) => {
    try {
        ...
        const keyMaterial = await crypto.subtle.importKey('raw', encoder.encode(encryptionKey.padEnd(32, '0').substring(0, 32)), { name: 'AES-GCM' }, false, ['decrypt']);
        // Decode base64
        ...
        // Decrypt
        const decryptedData = await crypto.subtle.decrypt({ name: 'AES-GCM', iv }, keyMaterial, encryptedData);
