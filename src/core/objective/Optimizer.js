const broadcastLog = (scope, message, level) => {
...
export class ObjectiveOptimizer {
     ...
     */
    static evaluate(code, objective) {
     ...
     */
    static getRefactorPrompt(code, objective) {
        return `
