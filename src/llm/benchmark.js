...
`;
     ...
     */
    saveResults(result) {
        const outputPath = path.join(this.config.outputDir, `${this.config.modelName}_benchmark.json`);
     ...
     */
    static generateComparisonReport(results, outputPath) {
        const report = {
