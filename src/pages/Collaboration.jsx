...
export default function Collaboration() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <CardHeader className="pb-3 flex items-center justify-between flex-row">
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                  Live collaborative editing session
                </p>
              </div>
              <div className="flex gap-2">
                <Badge variant="outline" className={isConnected ? "bg-green-50 dark:bg-green-950" : "bg-red-50 dark:bg-red-950"}>
      ...
      {!showLiveEditor && isAuthenticated && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
            ...
            <CardContent>
              {showNewDocForm && (
                <motion.div
                  ...
                  className="mb-4 p-4 border border-slate-200 dark:border-slate-700 rounded-lg space-y-3"
                >
                  <Input
              ...
              {isLoadingDocs ? (
                <p className="text-sm text-slate-600 dark:text-slate-400">Loading documents...</p>
              ) : documents.length === 0 ? (
                <p className="text-sm text-slate-600 dark:text-slate-400">No documents yet. Create one to get started!</p>
              ) : (
              ...
              {session && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-4 h-48 overflow-y-auto mb-2 space-y-2">
      ...
      {!showLiveEditor && (
        ...
        >
          ...
          <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
            ...
            <CardContent>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                View team members' cursor positions as they navigate documents. Better coordination and awareness.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
            ...
            <CardContent>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Operational Transformation ensures no data loss. Automatic conflict resolution with version control.
              </p>
            </CardContent>
          </Card>
        </motion.div>
