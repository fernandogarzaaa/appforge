...
export class HyperModelRouter {
  ...
  private readonly defaultConfig = {
    ...
    mediumComplexityModel: 'claude' as ModelId,
    highComplexityModel: 'gpt4' as ModelId,
  ...
  private async routeByComplexity(
    ...
    switch (complexity) {
      ...
      case 'medium':
        ...
        if (type === 'code') {
          primaryModel = 'claude';
          rationale = 'Medium complexity code task - using Claude for balanced reasoning';
          fallbackModels = ['gpt4', 'ollama_local'];
        } else if (requiresMultiModal) {
          primaryModel = 'gpt4';
          rationale = 'Medium complexity multimodal - using GPT-4 for full capabilities';
          fallbackModels = ['gemini', 'claude'];
        } else {
          primaryModel = 'claude';
          rationale = 'Medium complexity reasoning - using Claude for balance of speed and capability';
          fallbackModels = ['willow', 'gpt4'];
        }
        break;
      ...
      default:
        ...
        if (type === 'safety') {
          ...
          rationale = 'High complexity safety-critical - using consensus ensemble';
          fallbackModels = ['gpt4', 'claude', 'willow'];
        } else if (requiresMultiModal) {
          primaryModel = 'gpt4';
          rationale = 'High complexity multimodal - using GPT-4 maximum capability';
          fallbackModels = ['gemini', 'consensus'];
        } else {
          primaryModel = 'gpt4';
          rationale = 'High complexity reasoning - using GPT-4 for maximum capability';
          fallbackModels = ['claude', 'consensus', 'willow'];
        }
        break;
    }
