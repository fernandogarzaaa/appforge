 ...
 */
export function configureSecureEntropy(userConfig) {
 ...
 */
export function getSecureEntropyConfig() {
    return { ...config };
}
/**
 ...
 */
export function secureRandomBoolean(trueProbability = 0.5) {
    if (config.deterministic) {
 ...
 */
export function secureRandomElement(array) {
    if (array.length === 0) {
 ...
 */
export function setDeterministicSeed(seed) {
 ...
 */
export function validateEntropySource() {
