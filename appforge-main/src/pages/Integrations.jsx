              ...
              <Card key={idx} className="hover:shadow-lg transition-all">
                <CardHeader>
                  <div className="flex items-start justify-between mb-2">
                    <div 
                      className={`w-12 h-12 rounded-lg flex items-center justify-center ${colorMap[integration.color]?.bg || 'bg-gray-100'}`}
                    >
                      <IntegrationIcon 
                        className={`w-6 h-6 ${colorMap[integration.color]?.text || 'text-gray-600'}`}
                      />
                    </div>
